...
import snakemake.sub_preprocess_S1 as s1
import snakemake.sub_preprocess_S2 as s2


def preprocess_selector(ref_path, file_info):
    """src that selects the preprocessing function for the first step, either dlc or not"""
