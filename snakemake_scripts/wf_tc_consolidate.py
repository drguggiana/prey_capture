...
if __name__ == '__main__':
    ...
    rigs = rigs[rev_sort]
    input_paths = input_paths[rev_sort]
    ...
    if empty_flag:
        ...
        for data, rig in zip(data_list, rigs):
            ...
            for feature in data.keys():
                ...
                # Save matched TCs
                if ('counts' not in feature) and ('edges' not in feature):
                    ...
                    # save unmatched tcs
                    unmatched_feature = data[feature].df.drop(match_idxs, axis=0).reset_index(names=['original_cell_id'])
